	      		...
	      		<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<div class="dropdown">
					    ...
					    <ul class="dropdown-menu">
					    	...
					    	<li class="active"><a href="cadastro_fornecedor.php">Cadastrar novo</a></li>
					    	<li class="divider"></li>
...
<div class="container">
	<div style="width: 300px; background-color: #FFF; border-radius: 0 10px 0 10px;">
	  <form method="POST" action="cadastro_fornecedor2.php" class="px-4 py-3">
	    <div class="form-group">
	      <label>Nome do Fornecedor</label>
	      <input type="text" name="fornecedor" class="form-control" placeholder="Digite um novo Fornecedor">
	    </div>
	    <center>
