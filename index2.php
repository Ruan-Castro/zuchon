...
<div class="container">
	<div class="login">
		...
		<div class="dados-login">
			<form method="POST" action="./php/valida2.php" class="px-4 py-3">
			  	<center><h1>Login de Técnico</h1></center>
			    ...
			    <center>
			    	...
			    	<div class="tecnico-usuario">Usuário? Clique <a href="./index.php">aqui</a></div>
					<div class="footer">
